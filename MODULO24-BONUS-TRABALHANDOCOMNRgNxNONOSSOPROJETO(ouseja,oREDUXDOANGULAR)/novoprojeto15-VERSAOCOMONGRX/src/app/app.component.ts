...
export class AppComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private loggingService: LoggingService, private store: Store<AppState>) {}
  ...
  ngOnInit(): void {  
    ...
    //substituímos o 'autoLogin()' method lá de nosso service POR UMA VERSÃO NGRX 'effects' dele..
